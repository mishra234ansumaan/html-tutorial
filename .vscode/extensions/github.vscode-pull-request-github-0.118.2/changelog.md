...
![Todo comment with "delegate to coding agent" action](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.118.0/delegate-to-coding-agent-action.png)
...
![Collapsed sidbar content on a narrow view](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.118.0/collapsed-sidbar-content.png)
...
* [@krassowski (Michał Krassowski)](https://github.com/krassowski): Fix typo "will be replace" → "will be replaced" [PR [#7540](https://github.com/Microsoft/vscode-pull-request-github/issues/7540)](https://github.com/microsoft/vscode-pull-request-github/pull/7540)
...
![pull request card in chat](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.116.0/pr-card-in-chat.png)
...
![simplified button bar in pull request header](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.116.0/simplified-pr-header-buttons.png)

![pull request copy actions moved to link context menu](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.116.0/pr-header-copy-actions.png)

- You can see a summary of the Copilot coding agent's status in the "Copilot on My Behalf" tree item

![coding agent summary](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.116.0/coding-agent-status.png)
...
![suggestion in scm input to configure queries](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.116.0/suggest-configure-queries.png)
...
![Coding Agent Start](https://github.com/Microsoft/vscode-pull-request-github/raw/HEAD/documentation/changelog/0.114.0/coding-agent-start.png)
